<div class="id-card horizontal template-50" style="background-color: #ffffff;">
    <div class="header" style="background: #143601; color: #ffffff; border-bottom: 4px solid #2C6E49; padding-top: 15px;">
