<div class="id-card horizontal template-2" style="background-color: #ffffff;">
    <div class="header" style="background: #0F4C81; color: #fff; text-align: left; padding-left: 15px;">
