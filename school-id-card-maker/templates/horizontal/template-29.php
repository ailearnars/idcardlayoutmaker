<div class="id-card horizontal template-29" style="background-color: #fefcfb;">
    <div class="header" style="border: none; text-align: left; padding-left: 20px;">
                <h2 class="school-name" style="color: #370617; font-weight: normal;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body">
        ...
        <div class="details" style="top: 15px; left: 120px;">
