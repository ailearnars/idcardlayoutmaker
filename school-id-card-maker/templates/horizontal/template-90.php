<div class="id-card horizontal template-90" style="background-color: #ffffff;">
    <div class="header" style="background: #22223b; color: #ffffff; border-bottom: 4px solid #9a8c98; padding-top: 15px;">
