<div class="id-card horizontal template-17" style="background-color: #ffffff;">
    <div class="header" style="background: #2B6CB0; color: #fff; text-align: left; padding-left: 15px;">
