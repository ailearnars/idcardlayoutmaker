<div class="id-card horizontal template-20" style="background-color: #ffffff;">
    <div class="header" style="background: #1A365D; color: #ebf8ff; border-bottom: 4px solid #2B6CB0; padding-top: 15px;">
                <h2 class="school-name" style="color: #ebf8ff; font-size: 16px;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        ...
        <div class="details" style="top: 10px; left: 115px; right: 5px;">
            <h3 class="name" style="color: #2B6CB0; border-color: #2B6CB0; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
            <table>
