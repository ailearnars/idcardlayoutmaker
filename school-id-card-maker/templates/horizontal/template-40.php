<div class="id-card horizontal template-40" style="background-color: #ffffff;">
    <div class="header" style="background: #222222; color: #ffffff; border-bottom: 4px solid #4A4A4A; padding-top: 15px;">
