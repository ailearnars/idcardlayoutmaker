<div class="id-card horizontal template-26" style="background-color: #fefcfb;">
    <div class="header" style="border-bottom: 3px solid #E85D04; background: #fff;">
                <?php if (!empty($student->school_logo)): ?><img src="<?php echo esc_url($student->school_logo); ?>" class="logo" alt="Logo"><?php endif; ?>
                <h2 class="school-name" style="color: #E85D04"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body">
        <div class="photo-container" style="top: 15px; left: 15px; border-radius: 0; border: 2px solid #E85D04; box-shadow: none;">
        ...
        <div class="details" style="top: 15px; left: 115px;">
            <h3 class="name" style="color: #E85D04; border-color: #E85D04;"><?php echo esc_html($student->student_name); ?></h3>
            <table>
    ...
    <div class="footer" style="background-color: #370617; color: #fefcfb;">
        <p class="school-address" style="color: #fefcfb;"><?php echo nl2br(esc_html(get_option('school_id_card_default_school_address', '123 Default St.'))); ?></p>
