<div class="id-card horizontal template-108" style="background-color: #ffffff;">
    <div class="header" style="background: #7209b7; color: #fff; text-align: left; padding: 12px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        ...
        <div class="details" style="top: 10px; left: 110px; right: 5px;">
            <h3 class="name" style="color: #7209b7; font-weight: bold; margin-bottom: 4px; text-transform: uppercase;"><?php echo esc_html($student->student_name); ?></h3>
    ...
    <div class="footer" style="background-color: #3a0ca3; color: #ffffff; border-top: 2px solid #7209b7;">
