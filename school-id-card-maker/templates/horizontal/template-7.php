<div class="id-card horizontal template-7" style="background-color: #ffffff;">
    <div class="header" style="background: #C8102E; color: #fff; text-align: left; padding-left: 15px;">
