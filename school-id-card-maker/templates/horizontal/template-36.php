<div class="id-card horizontal template-36" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 15px; left: 15px; border-radius: 0; border: 2px solid #4A4A4A; box-shadow: none;">
