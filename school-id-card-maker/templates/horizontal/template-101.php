<div class="id-card horizontal template-101" style="background-color: #ffffff;">
    <div class="header" style="background: linear-gradient(90deg, #fca311 0%, #14213d 100%); color: #fff; text-align: left; padding: 10px 15px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; right: 15px; left: auto; border-radius: 4px; border: 2px solid #fca311; box-shadow: none;">
        ...
        <div class="details" style="top: 10px; left: 15px; right: 110px; text-align: left; border-left: 4px solid #fca311; padding-left: 10px;">
