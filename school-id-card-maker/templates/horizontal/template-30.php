<div class="id-card horizontal template-30" style="background-color: #fefcfb;">
    <div class="header" style="background: #370617; color: #fefcfb; border-bottom: 4px solid #E85D04; padding-top: 15px;">
                <h2 class="school-name" style="color: #fefcfb; font-size: 16px;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body">
