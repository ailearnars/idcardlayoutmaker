<div class="id-card horizontal template-32" style="background-color: #ffffff;">
    <div class="header" style="background: #118AB2; color: #fff; text-align: left; padding-left: 15px;">
