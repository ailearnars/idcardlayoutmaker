<div class="id-card horizontal template-58" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 1px solid #D4A373; padding-bottom: 5px; background: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 15px; left: 15px; border-radius: 50%; width: 85px; height: 85px; border: 3px solid #D4A373;">
