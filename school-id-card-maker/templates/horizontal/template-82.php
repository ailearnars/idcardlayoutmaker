<div class="id-card horizontal template-82" style="background-color: #ffffff;">
    <div class="header" style="background: #00b4d8; color: #fff; text-align: left; padding-left: 15px;">
