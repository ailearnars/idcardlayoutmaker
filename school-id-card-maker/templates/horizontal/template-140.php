<div class="id-card horizontal template-140" style="background-color: #ffffff;">
    <div class="header" style="background: #d62828; color: #ffffff; text-align: center; border-top: 10px solid #003049;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; left: 20px; transform: rotate(-3deg); border: 2px solid #003049; box-shadow: 2px 2px 5px rgba(0,0,0,0.1);">
