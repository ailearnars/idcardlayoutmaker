<div class="id-card horizontal template-21" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 15px; left: 15px; border-radius: 0; border: 2px solid #5A2A82; box-shadow: none;">
