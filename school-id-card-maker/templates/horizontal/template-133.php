<div class="id-card horizontal template-133" style="background-color: #ffffff;">
    <div class="header" style="background: #023047; color: #fff; text-align: left; padding: 12px;">
