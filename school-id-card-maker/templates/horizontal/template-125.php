<div class="id-card horizontal template-125" style="background-color: #ffffff;">
    <div class="header" style="background: #8338ec; color: #ffffff; text-align: center; border-top: 10px solid #ff006e;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; left: 20px; transform: rotate(-3deg); border: 2px solid #ff006e; box-shadow: 2px 2px 5px rgba(0,0,0,0.1);">
