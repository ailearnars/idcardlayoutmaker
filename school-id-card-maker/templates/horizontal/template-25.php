<div class="id-card horizontal template-25" style="background-color: #ffffff;">
    <div class="header" style="background: #5A2A82; color: #ffffff; border-bottom: 4px solid #5A2A82; padding-top: 15px;">
