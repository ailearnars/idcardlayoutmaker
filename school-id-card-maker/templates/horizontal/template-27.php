<div class="id-card horizontal template-27" style="background-color: #fefcfb;">
    <div class="header" style="background: #E85D04; color: #fff; text-align: left; padding-left: 15px;">
