<div class="id-card horizontal template-52" style="background-color: #ffffff;">
    <div class="header" style="background: #D90429; color: #fff; text-align: left; padding-left: 15px;">
