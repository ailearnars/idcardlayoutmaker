<div class="id-card horizontal template-23" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 1px solid #5A2A82; padding-bottom: 5px; background: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 15px; left: 15px; border-radius: 50%; width: 85px; height: 85px; border: 3px solid #5A2A82;">
        ...
        <div class="details" style="top: 10px; left: 115px; right: 5px;">
            <h3 class="name" style="color: #5A2A82; border-color: #5A2A82; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
            <table>
