<div class="id-card horizontal template-120" style="background-color: #ffffff;">
    <div class="header" style="background: #118ab2; color: #ffffff; text-align: center; border-top: 10px solid #06d6a0;">
                <h2 class="school-name" style="color: #ffffff;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; left: 20px; transform: rotate(-3deg); border: 2px solid #06d6a0; box-shadow: 2px 2px 5px rgba(0,0,0,0.1);">
