<div class="id-card horizontal template-122" style="background-color: #ffffff;">
    <div class="header" style="background: #222; border-bottom: 2px dashed #ff006e; color: #fff; text-align: center;">
                ...
                <h2 class="school-name" style="color: #ff006e; font-family: monospace;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
