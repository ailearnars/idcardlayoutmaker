<div class="id-card horizontal template-99" style="background-color: #f1faee;">
    <div class="header" style="border: none; text-align: left; padding-left: 20px;">
                <h2 class="school-name" style="color: #1d3557; font-weight: normal;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body">
