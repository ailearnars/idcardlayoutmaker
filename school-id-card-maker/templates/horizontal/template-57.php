<div class="id-card horizontal template-57" style="background-color: #ffffff;">
    <div class="header" style="background: #D4A373; color: #fff; text-align: left; padding-left: 15px;">
