<div class="id-card horizontal template-12" style="background-color: #ffffff;">
    <div class="header" style="background: #005A36; color: #fff; text-align: left; padding-left: 15px;">
