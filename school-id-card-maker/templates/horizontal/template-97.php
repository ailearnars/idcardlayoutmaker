<div class="id-card horizontal template-97" style="background-color: #ffffff;">
    <div class="header" style="background: #e63946; color: #fff; text-align: left; padding-left: 15px;">
