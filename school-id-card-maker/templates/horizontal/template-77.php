<div class="id-card horizontal template-77" style="background-color: #ffffff;">
    <div class="header" style="background: #D62828; color: #fff; text-align: left; padding-left: 15px;">
