<div class="id-card horizontal template-94" style="background-color: #ffffff;">
    <div class="header" style="border: none; text-align: left; padding-left: 20px; background: #fff;">
                <h2 class="school-name" style="color: #023047; font-weight: normal;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        ...
        <div class="details" style="top: 10px; left: 120px; right: 5px;">
            <h3 class="name" style="color: #fb8500; border-color: #fb8500; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
            <table>
