<div class="id-card horizontal template-134" style="background-color: #ffffff;">
    <div class="header" style="background: #fff; border-bottom: 5px solid #219ebc; padding: 8px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; left: 15px; border-radius: 50%; width: 80px; height: 80px; border: 4px solid #023047;">
