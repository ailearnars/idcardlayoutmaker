<div class="id-card horizontal template-138" style="background-color: #ffffff;">
    <div class="header" style="background: #003049; color: #fff; text-align: left; padding: 12px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        ...
        <div class="details" style="top: 10px; left: 110px; right: 5px;">
            <h3 class="name" style="color: #003049; font-weight: bold; margin-bottom: 4px; text-transform: uppercase;"><?php echo esc_html($student->student_name); ?></h3>
    ...
    <div class="footer" style="background-color: #d62828; color: #ffffff; border-top: 2px solid #003049;">
