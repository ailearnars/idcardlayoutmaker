<div class="id-card horizontal template-45" style="background-color: #ffffff;">
    <div class="header" style="background: #9B2226; color: #ffffff; border-bottom: 4px solid #9B2226; padding-top: 15px;">
