<div class="id-card horizontal template-42" style="background-color: #ffffff;">
    <div class="header" style="background: #9B2226; color: #fff; text-align: left; padding-left: 15px;">
