<div class="id-card horizontal template-121" style="background-color: #ffffff;">
    <div class="header" style="background: linear-gradient(90deg, #ff006e 0%, #8338ec 100%); color: #fff; text-align: left; padding: 10px 15px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; right: 15px; left: auto; border-radius: 4px; border: 2px solid #ff006e; box-shadow: none;">
        ...
        <div class="details" style="top: 10px; left: 15px; right: 110px; text-align: left; border-left: 4px solid #ff006e; padding-left: 10px;">
