<div class="id-card horizontal template-113" style="background-color: #ffffff;">
    <div class="header" style="background: #1d3557; color: #fff; text-align: left; padding: 12px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        ...
        <div class="details" style="top: 10px; left: 110px; right: 5px;">
            <h3 class="name" style="color: #1d3557; font-weight: bold; margin-bottom: 4px; text-transform: uppercase;"><?php echo esc_html($student->student_name); ?></h3>
    ...
    <div class="footer" style="background-color: #457b9d; color: #ffffff; border-top: 2px solid #1d3557;">
