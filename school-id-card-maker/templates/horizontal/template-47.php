<div class="id-card horizontal template-47" style="background-color: #ffffff;">
    <div class="header" style="background: #2C6E49; color: #fff; text-align: left; padding-left: 15px;">
