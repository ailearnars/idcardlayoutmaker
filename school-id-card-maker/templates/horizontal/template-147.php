<div class="id-card horizontal template-147" style="background-color: #ffffff;">
    <div class="header" style="background: #222; border-bottom: 2px dashed #d5bdaf; color: #fff; text-align: center;">
                ...
                <h2 class="school-name" style="color: #d5bdaf; font-family: monospace;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; left: 15px; border-radius: 0; border: 2px solid #222;">
        ...
        <div class="details" style="top: 10px; left: 110px; right: 5px; font-family: monospace;">
