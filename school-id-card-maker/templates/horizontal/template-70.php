<div class="id-card horizontal template-70" style="background-color: #ffffff;">
    <div class="header" style="background: #161A1D; color: #ffffff; border-bottom: 4px solid #E5383B; padding-top: 15px;">
