<div class="id-card horizontal template-95" style="background-color: #ffffff;">
    <div class="header" style="background: #023047; color: #ffffff; border-bottom: 4px solid #fb8500; padding-top: 15px;">
