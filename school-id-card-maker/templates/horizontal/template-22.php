<div class="id-card horizontal template-22" style="background-color: #ffffff;">
    <div class="header" style="background: #5A2A82; color: #fff; text-align: left; padding-left: 15px;">
