<div class="id-card horizontal template-81" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 3px solid #00b4d8; background: #fff;">
                ...
                <h2 class="school-name" style="color: #00b4d8"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 15px; left: 15px; border-radius: 0; border: 2px solid #00b4d8; box-shadow: none;">
        ...
        <div class="details" style="top: 10px; left: 115px; right: 5px;">
            <h3 class="name" style="color: #00b4d8; border-color: #00b4d8; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
            <table>
    ...
    <div class="footer" style="background-color: #03045e; color: #ffffff;">
