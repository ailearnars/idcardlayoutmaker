<div class="id-card horizontal template-5" style="background-color: #ffffff;">
    <div class="header" style="background: #0F4C81; color: #ffffff; border-bottom: 4px solid #0F4C81; padding-top: 15px;">
