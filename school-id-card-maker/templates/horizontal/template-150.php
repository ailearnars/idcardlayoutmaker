<div class="id-card horizontal template-150" style="background-color: #ffffff;">
    <div class="header" style="background: #e3d5ca; color: #000000; text-align: center; border-top: 10px solid #d5bdaf;">
                <h2 class="school-name" style="color: #000000;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="top: 10px; left: 20px; transform: rotate(-3deg); border: 2px solid #d5bdaf; box-shadow: 2px 2px 5px rgba(0,0,0,0.1);">
