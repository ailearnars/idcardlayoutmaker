<div class="id-card horizontal template-103" style="background-color: #ffffff;">
    <div class="header" style="background: #fca311; color: #fff; text-align: left; padding: 12px;">
    ...
    <div class="body" style="background-color: #ffffff;">
        ...
        <div class="details" style="top: 10px; left: 110px; right: 5px;">
            <h3 class="name" style="color: #fca311; font-weight: bold; margin-bottom: 4px; text-transform: uppercase;"><?php echo esc_html($student->student_name); ?></h3>
    ...
    <div class="footer" style="background-color: #14213d; color: #ffffff; border-top: 2px solid #fca311;">
