<div class="id-card vertical template-71" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 3px solid #F4A261; background: #fff;">
                ...
                <h2 class="school-name" style="color: #F4A261"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #F4A261; box-shadow: none;">
        ...
        <div class="details">
            <h3 class="name" style="color: #F4A261; font-size: 15px; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
