<div class="id-card vertical template-5" style="background-color: #ffffff;">
    <div class="header" style="background: #0F4C81; color: #ffffff; border-bottom: 5px solid #0F4C81; padding-top: 20px;">
