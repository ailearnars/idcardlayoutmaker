<div class="id-card vertical template-110" style="background-color: #ffffff;">
    <div class="header" style="background: #3a0ca3; color: #ffffff; border-top: 10px solid #7209b7;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #7209b7; box-shadow: 3px 3px 0 #3a0ca3; margin-bottom: 5px;">
