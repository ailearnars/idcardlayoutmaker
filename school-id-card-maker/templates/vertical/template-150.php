<div class="id-card vertical template-150" style="background-color: #ffffff;">
    <div class="header" style="background: #e3d5ca; color: #000000; border-top: 10px solid #d5bdaf;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #d5bdaf; box-shadow: 3px 3px 0 #e3d5ca; margin-bottom: 5px;">
