<div class="id-card vertical template-96" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #e63946; box-shadow: none;">
        ...
        <div class="details">
            <h3 class="name" style="color: #e63946; font-size: 16px; margin-bottom: 12px;"><?php echo esc_html($student->student_name); ?></h3>
