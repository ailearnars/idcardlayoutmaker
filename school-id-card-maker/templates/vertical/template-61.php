<div class="id-card vertical template-61" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #3F37C9; box-shadow: none;">
        ...
        <div class="details">
            <h3 class="name" style="color: #3F37C9; font-size: 15px; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
