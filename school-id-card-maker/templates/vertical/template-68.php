<div class="id-card vertical template-68" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 1px solid #E5383B; padding-bottom: 10px; background: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 50%; width: 90px; height: 90px; border: 3px solid #E5383B; margin-bottom: 15px;">
