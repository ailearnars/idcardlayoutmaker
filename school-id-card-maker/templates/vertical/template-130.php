<div class="id-card vertical template-130" style="background-color: #ffffff;">
    <div class="header" style="background: #386641; color: #ffffff; border-top: 10px solid #bc4749;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #bc4749; box-shadow: 3px 3px 0 #386641; margin-bottom: 5px;">
