<div class="id-card vertical template-145" style="background-color: #ffffff;">
    <div class="header" style="background: #283618; color: #ffffff; border-top: 10px solid #606c38;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #606c38; box-shadow: 3px 3px 0 #283618; margin-bottom: 5px;">
