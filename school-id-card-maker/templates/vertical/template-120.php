<div class="id-card vertical template-120" style="background-color: #ffffff;">
    <div class="header" style="background: #118ab2; color: #ffffff; border-top: 10px solid #06d6a0;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #06d6a0; box-shadow: 3px 3px 0 #118ab2; margin-bottom: 5px;">
