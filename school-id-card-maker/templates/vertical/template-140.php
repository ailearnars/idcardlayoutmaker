<div class="id-card vertical template-140" style="background-color: #ffffff;">
    <div class="header" style="background: #d62828; color: #ffffff; border-top: 10px solid #003049;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #003049; box-shadow: 3px 3px 0 #d62828; margin-bottom: 5px;">
