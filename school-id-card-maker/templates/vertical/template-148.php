<div class="id-card vertical template-148" style="background-color: #ffffff;">
    <div class="header" style="background: #d5bdaf; color: #fff; padding-bottom: 15px;">
                ...
                <h2 class="school-name" style="color: #fff; text-transform: uppercase;"><?php echo esc_html(!empty($student->school_name) ? $student->school_name : get_option("school_id_card_default_school_name", "Default School")); ?></h2>
            </div>
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 8px; border: 4px solid #fff; margin-top: -20px; position: relative; z-index: 5; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
