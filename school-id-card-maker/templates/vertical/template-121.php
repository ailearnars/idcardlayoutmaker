<div class="id-card vertical template-121" style="background-color: #ffffff;">
    <div class="header" style="background: linear-gradient(180deg, #ff006e 0%, #8338ec 100%); color: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 4px; border: 2px solid #ff006e; box-shadow: none;">
