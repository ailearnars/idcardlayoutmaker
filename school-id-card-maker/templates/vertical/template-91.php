<div class="id-card vertical template-91" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #fb8500; box-shadow: none;">
