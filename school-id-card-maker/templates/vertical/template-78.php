<div class="id-card vertical template-78" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 1px solid #D62828; padding-bottom: 10px; background: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 50%; width: 90px; height: 90px; border: 3px solid #D62828; margin-bottom: 15px;">
