<div class="id-card vertical template-116" style="background-color: #ffffff;">
    <div class="header" style="background: linear-gradient(180deg, #06d6a0 0%, #118ab2 100%); color: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 4px; border: 2px solid #06d6a0; box-shadow: none;">
