<div class="id-card vertical template-98" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 1px solid #e63946; padding-bottom: 10px; background: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 50%; width: 90px; height: 90px; border: 3px solid #e63946; margin-bottom: 15px;">
