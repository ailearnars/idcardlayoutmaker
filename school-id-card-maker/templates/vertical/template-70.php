<div class="id-card vertical template-70" style="background-color: #ffffff;">
    <div class="header" style="background: #161A1D; color: #ffffff; border-bottom: 5px solid #E5383B; padding-top: 20px;">
