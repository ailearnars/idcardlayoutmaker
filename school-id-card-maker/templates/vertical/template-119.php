<div class="id-card vertical template-119" style="background-color: #ffffff;">
    <div class="header" style="background: #fff; border-bottom: 5px solid #118ab2;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 50%; width: 75px; height: 75px; border: 4px solid #06d6a0; margin-bottom: 5px; margin-top: 5px;">
