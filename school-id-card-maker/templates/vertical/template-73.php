<div class="id-card vertical template-73" style="background-color: #ffffff;">
    <div class="header" style="border-bottom: 1px solid #F4A261; padding-bottom: 10px; background: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 50%; width: 75px; height: 75px; border: 3px solid #F4A261; margin-bottom: 10px;">
