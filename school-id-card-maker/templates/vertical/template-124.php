<div class="id-card vertical template-124" style="background-color: #ffffff;">
    <div class="header" style="background: #fff; border-bottom: 5px solid #8338ec;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 50%; width: 75px; height: 75px; border: 4px solid #ff006e; margin-bottom: 5px; margin-top: 5px;">
