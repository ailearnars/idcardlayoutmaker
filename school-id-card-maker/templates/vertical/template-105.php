<div class="id-card vertical template-105" style="background-color: #ffffff;">
    <div class="header" style="background: #14213d; color: #ffffff; border-top: 10px solid #fca311;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #fca311; box-shadow: 3px 3px 0 #14213d; margin-bottom: 5px;">
