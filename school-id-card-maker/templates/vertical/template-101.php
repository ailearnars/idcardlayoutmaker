<div class="id-card vertical template-101" style="background-color: #ffffff;">
    <div class="header" style="background: linear-gradient(180deg, #fca311 0%, #14213d 100%); color: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 4px; border: 2px solid #fca311; box-shadow: none;">
