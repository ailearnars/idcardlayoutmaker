<div class="id-card vertical template-135" style="background-color: #ffffff;">
    <div class="header" style="background: #219ebc; color: #ffffff; border-top: 10px solid #023047;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #023047; box-shadow: 3px 3px 0 #219ebc; margin-bottom: 5px;">
