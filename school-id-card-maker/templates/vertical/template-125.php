<div class="id-card vertical template-125" style="background-color: #ffffff;">
    <div class="header" style="background: #8338ec; color: #ffffff; border-top: 10px solid #ff006e;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border: 2px solid #ff006e; box-shadow: 3px 3px 0 #8338ec; margin-bottom: 5px;">
