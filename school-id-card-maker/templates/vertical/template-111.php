<div class="id-card vertical template-111" style="background-color: #ffffff;">
    <div class="header" style="background: linear-gradient(180deg, #1d3557 0%, #457b9d 100%); color: #fff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 4px; border: 2px solid #1d3557; box-shadow: none;">
