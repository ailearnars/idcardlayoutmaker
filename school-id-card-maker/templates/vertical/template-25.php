<div class="id-card vertical template-25" style="background-color: #ffffff;">
    <div class="header" style="background: #5A2A82; color: #ffffff; border-bottom: 5px solid #5A2A82; padding-top: 20px;">
