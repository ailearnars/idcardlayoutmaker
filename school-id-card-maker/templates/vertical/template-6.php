<div class="id-card vertical template-6" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #C8102E; box-shadow: none;">
        ...
        <div class="details">
            <h3 class="name" style="color: #C8102E; font-size: 16px; margin-bottom: 12px;"><?php echo esc_html($student->student_name); ?></h3>
