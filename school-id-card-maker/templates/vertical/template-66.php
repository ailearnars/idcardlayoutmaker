<div class="id-card vertical template-66" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #E5383B; box-shadow: none;">
        ...
        <div class="details">
            <h3 class="name" style="color: #E5383B; font-size: 16px; margin-bottom: 12px;"><?php echo esc_html($student->student_name); ?></h3>
