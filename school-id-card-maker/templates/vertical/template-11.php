<div class="id-card vertical template-11" style="background-color: #ffffff;">
    ...
    <div class="body" style="background-color: #ffffff;">
        <div class="photo-container" style="border-radius: 0; border: 2px solid #005A36; box-shadow: none;">
        ...
        <div class="details">
            <h3 class="name" style="color: #005A36; font-size: 15px; margin-bottom: 4px;"><?php echo esc_html($student->student_name); ?></h3>
